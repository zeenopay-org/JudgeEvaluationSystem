...
import { createContestant , deleteContestants, editContestant, getContestant, getSingleContestant} from "../controllers/contestantController.js";
...
router.delete('/delete/:id',authMiddleware,adminOnlyMiddleware,deleteContestants)
